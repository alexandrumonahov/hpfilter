...
#' @examples
#'   hp1(y, lambda = "400000") # Calculate the one-sided HP filter using a smoothing parameter of 400000
#'   hp2(y, lambda = "1600")   # Calculate the rwo-sided HP filter using a smoothing parameter of 1600
...
#'
#' @source Copyright Alexandru Monahov, 2023. You may use, modify and redistribute this code, provided that you give credit to the author and make any derivative work available to the public for free.
"_PACKAGE"
